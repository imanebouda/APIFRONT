    ...
    public class CategorieController : ControllerBase
    {
        ...
        public async Task<object> Search(Object record)
        {
            ...
            try
            {
                ...
                {
                    dataResult = await _categorieService.Search(record);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<object> Insert(Object record)
        {
            ...
            try
            {
                ...
                {
                    dataResult = await _categorieService.Insert(record);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<object> Update(Object record)
        {
            ...
            try
            {
                ...
                {
                    dataResult = await _categorieService.Update(record);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<object> Delete(Object record)
        {
            ...
            try
            {
                ...
                {
                    dataResult = await _categorieService.Delete(record);
                }
            }
            catch (Exception ex)
            {
